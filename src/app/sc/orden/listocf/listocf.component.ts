...
import { RequestAnulacionSolicitud } from '../../solicitud/solicitud';
...
@Component({
  selector: 'app-listocf',
  templateUrl: './listocf.component.html',
  styleUrls: ['./listocf.component.scss'],
})
export class ListocfComponent implements OnInit {
...
//#endregion
  ...
  onOpenOrden(codigo_orden: string): void {
    this.router.navigate(['/sc/orden/detailocf/' + codigo_orden]);
