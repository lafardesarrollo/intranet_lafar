...
import { SolicitudCompra, RequestAnulacionSolicitud, RequestAutorizacionSolicitud, RequestFechaArte, FechaArte } from '../solicitud';
        ...
        data => {
          if (data['status'] == 304) {
              ...
              if (s.tipo == 'I') {
                ...
                this.toast.show('Se modifico correctamente!', 1000, 'green', () => this.router.navigate(['/sc/solicitud/list_aut/']));
              } else {
