...
@Component({
  selector: 'app-vismed',
  templateUrl: './vismed.component.html',
  styleUrls: ['./vismed.component.scss']
})
export class VismedComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    window.open(this.global.urlIntranet + 'vismed/', '_blank');
